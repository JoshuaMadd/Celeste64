...
public class World : Scene
{
	...
	public World(EntryInfo entry)
	{
		...
		// setup pause menu
		{
			...
			inputMenu.Title = "Input Config";
			inputMenu.Add(new Menu.InputOption("Jump: ", Controls.Jump));
			inputMenu.Add(new Menu.InputOption("Dash: ", Controls.Dash));
			inputMenu.Add(new Menu.InputOption("Climb: ", Controls.Climb));
			inputMenu.Add(new Menu.InputOption("Confirm: ", Controls.Confirm));
			inputMenu.Add(new Menu.InputOption("Cancel: ", Controls.Cancel));
			inputMenu.Add(new Menu.InputOption("Pause: ", Controls.Pause));
			...
			optionsMenu.Add(new Menu.Submenu("Input Config", pauseMenu, inputMenu));
			optionsMenu.Add(new Menu.Spacer());
